<div>
    @if ($show)
        <div class="fixed inset-0 z-40 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm"
            ...
            <div class="w-full max-w-lg bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                {{-- Body --}}
                <div class="px-5 py-4">
                    <livewire:usuarios.formulario :usuarioId="$usuarioId" />
                </div>
                ...
                <div class="flex justify-end gap-3 px-5 pb-5">
                    ...
                    <flux:button type="submit" form="usuario-form" variant="primary" wire:loading.attr="disabled">
