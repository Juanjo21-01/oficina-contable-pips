...
<head>
    ...
    <title>Oficina Contable "Méndez García & Asociados" - Página No Encontrada</title>
...
<body class="h-screen bg-gray-50 dark:bg-gray-900">
    <main class="h-screen flex justify-center items-center">
        <div class="container flex flex-col items-center px-6 mx-auto">
            ...
            <h1 class="text-8xl font-bold text-rose-500">404</h1>
            <h2 class="text-3xl font-semibold text-gray-800 dark:text-gray-200">Página No Encontrada</h2>
